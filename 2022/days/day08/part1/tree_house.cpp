...
bool
tree_house::is_visible_from_edge(const uint32_t &x, const uint32_t &y, const aoc_direction &direction, const uint32_t &check_val) {
	...
	is_visible |= this->is_visible_from_edge(cords.x, cords.y, direction, check_val);
